...
import (
	...
	operationModel "github.com/hantbk/vbackup/internal/entity/v1/operation"
	...
	"github.com/hantbk/vbackup/pkg/restic_source/rinternal/ui/table"
	"gopkg.in/tomb.v2"
)
...
func forget(opts ForgetOptions, ctx context.Context, repo *repository.Repository, snapshotids []string, spr *wsTaskInfo.Sprintf) error {
	...
	if len(snapshots) <= 0 {
		spr.Append(wsTaskInfo.Error, "Snapshot does not exist! ")
