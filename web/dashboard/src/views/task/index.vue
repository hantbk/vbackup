          ...
          <el-card class="card-h">
            ...
            <el-row :gutter="10">
              <template v-if="taskInfo.restoreError">
                <el-col v-for="(item,index) in taskInfo.restoreError" :key="index" :span="24">
                  <p>{{ item.error + '-' + item.item }}</p>
                </el-col>
              </template>
            </el-row>
          </el-card>
      ...
      <el-row v-if="taskInfo.progress" style="margin-top: 10px">
        <el-col :span="24">
          <el-card>
            ...
            <div>
              <div v-if="taskInfo.filelog">
                <p v-for="(item, index) in taskInfo.filelog" :key="index">{{ item }}</p>
              </div>
              <div v-if="taskInfo.progress.currentFiles">
                <p v-for="(item, index) in taskInfo.progress.currentFiles" :key="index">{{ item }}</p>
              </div>
            </div>
          </el-card>
        </el-col>
