    ...
    children: [
      {
        ...
        name: 'Dashboard',
        meta: { title: 'Home', icon: 'dashboard', affix: true, noCache: true }
      }
    ]
  },
  {
...
export const asyncRoutes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'Restore',
        meta: { title: 'Restore', activeMenu: '/repository/index' },
        hidden: true
      },
      {
        path: 'snapshot/:id',
        ...
        name: 'Snapshot',
        meta: { title: 'Snapshot', activeMenu: '/repository/index' },
        hidden: true
      },
      {
        path: 'operation/:id',
        ...
        name: 'Operation',
        meta: { title: 'Operation', activeMenu: '/repository/index' },
        hidden: true
      }
    ]
  },
    ...
    children: [
      {
        ...
        name: 'PlanList',
        meta: { title: 'Backup Plan', noCache: true }
      }
    ]
  },
  {
